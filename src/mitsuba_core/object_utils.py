...
class ObjectUtils:
    ...
    def ply2obj(self, ply_file_path: str, obj_file_path: str) -> bool:
        """
        Convierte archivo PLY a OBJ
        
        Args:
            ply_file_path: Ruta del archivo PLY origen
            obj_file_path: Ruta del archivo OBJ destino
        ...
        try:
            ...
            open3d.io.write_triangle_mesh(obj_file_path, mesh)
            return True
    ...
    def obj2ply(self, obj_file_path: str, ply_file_path: str) -> bool:
        """
        Convierte archivo OBJ a PLY
        
        Args:
            obj_file_path: Ruta del archivo OBJ origen
            ply_file_path: Ruta del archivo PLY destino
        ...
        try:
            ...
            open3d.io.write_triangle_mesh(ply_file_path, mesh)
            return True
        except HTTPException:
            raise
        except Exception as e:
